...
- **Actividad(es) del AS-IS que afecta:** [`ACT-AS-01A`](./01-proceso-as-is.md#act-as-01a--buscar-avisos-físicos-en-el-sector-universitario), [`ACT-AS-01B`](./01-proceso-as-is.md#act-as-01b--revisar-publicaciones-de-pensiones-en-redes-sociales) y [`ACT-AS-02`](./01-proceso-as-is.md#act-as-02--llamar-para-consultar-disponibilidad-y-precio) (Estudiante).
...
|-------------------------|--------------------------|------------|
| [`ACT-AS-01A`](./01-proceso-as-is.md#act-as-01a--buscar-avisos-físicos-en-el-sector-universitario) — Buscar avisos físicos y [`ACT-AS-01B`](./01-proceso-as-is.md#act-as-01b--revisar-publicaciones-de-pensiones-en-redes-sociales) — Revisar publicaciones en redes sociales | [`ACT-TOBE-01`](#act-tobe-01--buscar-pensión-y-aplicar-filtros) y [`ACT-TOBE-02`](#act-tobe-02--consultar-y-cargar-catálogo-en-tiempo-real) — Buscar pensión, aplicar filtros y cargar catálogo | La búsqueda dispersa en avisos físicos y publicaciones informales se reemplaza por un catálogo georreferenciado con filtros multicriterio y disponibilidad consultada en el sistema. |
